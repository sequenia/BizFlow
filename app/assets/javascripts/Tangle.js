...
var Tangle = this.Tangle = function (rootElement, modelClass) {
    ...
    function initializeElements() {
        ...
        for (var i = 0, length = elements.length; i < length; i++) {
            ...
            if (element.getAttribute("class") || element.getAttribute("ng-model")) {
        ...
        for (var i = 0, length = interestingElements.length; i < length; i++) {
            ...
            var varNames = null;
            var varAttribute = element.getAttribute("ng-model");
    ...
    function setValue(varName, value) {
       ...
       obj[varName] = value;       
       setValues(obj);
       console.log("setting value for" +  varName +" = " + value);
    }
